...
class RegistroCotizacionesUScreen extends StatefulWidget {
  @override
...
class _RegistroCotizacionesScreenState
    extends State<RegistroCotizacionesUScreen> {
  final CotizacionUService _cotizacionService = CotizacionUService();
