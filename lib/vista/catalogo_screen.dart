...
import 'package:clase5/vista/salon_detalles_screen.dart';
import 'package:clase5/vista/agregar_salon_screen.dart';
                      ...
                      leading: ClipRRect(
                        ...
                        child: Image.network(
                          ...
                          errorBuilder: (context, error, stackTrace) {
                            // Mostrar una imagen por defecto en caso de error
                            return Image.asset(
                              'assets/images/default_salon_image.png',
                              width: 100,
                              height: 100,
                              fit: BoxFit.cover,
                            );
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => AgregarSalonScreen(),
            ),
          );
        },
        child: Icon(Icons.add),
        tooltip: 'Agregar nuevo salón',
      ),
    );
  }
}
